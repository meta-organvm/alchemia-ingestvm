...
### Siblings in Meta
`.github`, `organvm-corpvs-testamentvm`, `schema-definitions`, `organvm-engine`, `system-dashboard`, `organvm-mcp-server`, `praxis-perpetua`, `stakeholder-portal`, `materia-collider`, `organvm-ontologia`

### Governance
- *Standard ORGANVM governance applies*

*Last synced: 2026-03-20T00:59:56Z*
